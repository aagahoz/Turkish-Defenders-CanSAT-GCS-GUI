...
class KLEIN(object):
    ...
    def decrypt(self, key, ciphertext):
        state = ciphertext
        sk = self.keySchedule(key, self.nr)
...
def main():
    ...
    klein64 = KLEIN(nr=12, size=64)  # 64-bit encryption key
    ...
    decripted = klein64.decrypt(k, k64)
    print("Klein64: ", hex(k64))
    print("Klein80: ", hex(k80))
    print("Klein96: ", hex(k96))
    print("Decripted: ", hex(decripted))
    print(m)
