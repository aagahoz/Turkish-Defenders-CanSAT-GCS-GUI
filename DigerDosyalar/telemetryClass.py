class TelemetryData:
    ...
    def returnAsList(self):
        tempList = list()
        tempList.append(self.team_id)
        tempList.append(self.mission_time)
        tempList.append(self.packet_count)
        tempList.append(self.altitude)
        tempList.append(self.pressure)
        tempList.append(self.temp)
        tempList.append(self.volt)
        tempList.append(self.gps_time)
        tempList.append(self.gps_longitude)
        tempList.append(self.gps_latitude)
        tempList.append(self.gps_altitude)
        tempList.append(self.gps_sats)
        tempList.append(self.air_speed)
        tempList.append(self.particle_count)
        tempList.append(self.pitch)
        tempList.append(self.roll)
        tempList.append(self.yaw)
    ...
    def getDataAsList(self):
        ...
        dataS.append(str(self.air_speed))
        dataS.append(str(self.particle_count))
        dataS.append(str(self.pitch))
        dataS.append(str(self.roll))
        dataS.append(str(self.yaw))
