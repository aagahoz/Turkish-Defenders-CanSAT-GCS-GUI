...
class Example(QMainWindow):
        ...
        def __init__(self):
           ...
           # p.setColor(self.backgroundRole(), QColor(179, 206, 229))
            ...
            self.ser = serial.Serial('/dev/tty.usbserial-A50285BI', 9600, timeout=1)
            self.ser.flush()
        ...
        def initUI(self):
            ...
            self.connectButton.setGeometry(QtCore.QRect(79, 60, 100, 32))
            ...
            self.disconnectButton.setGeometry(QtCore.QRect(184, 60, 120, 32))
            ...
            self.importCsvButton.setGeometry(118,100,140,32)
            ...
            self.comSelector.setGeometry(QtCore.QRect(80, 25, 100, 40))    
            ...
            self.baudrateSelector.setGeometry(QtCore.QRect(195, 25, 100, 40))
            ...
            self.imageLabel.setPixmap(QPixmap("DigerDosyalar/3DMODELYENI.png"))
            ...
            self.data_line_altitude =  self.AltitudePlot.plot(self.xAltitude, self.yAltitude, pen=pen)
        ...
        def timerForOneSecond(self):
             if self.connectButtonActivated == True:
                ...
                self.oncekiBasinc = 1012
                telemetryDataS = hf.createRandomTestTelemetryObject()
                
                # telemetryDataS.altitude = round((telemetryDataS.pressure  - self.oncekiBasinc) * 5, 2)

                # self.oncekiBasinc = telemetryDataS.pressure
